...
This is a fork of the @telegraf/types library. This project will continue updating the Telegram Bot API types, but now for @tgify/bot. This project provides TypeScript types for the entire [Telegram Bot API](https://core.telegram.org/bots/api).
